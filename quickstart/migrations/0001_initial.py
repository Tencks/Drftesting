    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fotoUser', models.ImageField(blank='', default='', upload_to='usersFoto/')),
                ('descriptionUser', models.TextField(blank='', default='', max_length=400, null=True)),
                ('numCelular', models.CharField(blank='', default='', max_length=40, null=True)),
                ('direccion', models.CharField(default='', max_length=100, null=True)),
